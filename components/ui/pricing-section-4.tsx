  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
      {plans.map((plan, index) => (
        ...
        >
          <div className="relative flex flex-1 flex-col border border-white/[0.08] bg-gradient-to-br from-[#0A0E1A] via-[#0F1526] to-[#0A0E1A] p-6">
            {/* Name */}
            ...
            <a href="/contact" className="mb-6 block">
              <button className="w-full border border-brand-blue/40 py-3.5 text-sm font-medium text-[#F2F2EE] transition-colors hover:border-brand-blue/70 hover:bg-brand-blue/10">
                Get Started
              </button>
            </a>
